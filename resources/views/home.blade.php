            ...
            <div class="row">
              <div class="col-12 col-sm-7">
                <div class="d-flex align-items-center gap-3 mb-5">
                  <img src="{{ asset('dashbord_assets') }}/assets/images/avatars/1.1.png" class="rounded-circle bg-grd-info p-1" width="60" height="60" alt="user">
                  <div class="">
              ...
              <div class="col-12 col-sm-5">
                <div class="welcome-back-img pt-4">
                  <img src="{{ asset('dashbord_assets') }}/assets/images/gallery/welcome-back-3.png" height="180" alt="">
                </div>
              </div>
            </div><!--end row-->
          </div>
                  ...
                  <div class="card">
                    <div class="card-header">
                      <div class="d-flex justify-content-between">
                        ...
                        <a href="{{url('send/newsletter')}}" class="btn btn-info">Send NewsLetter to {{ $total_users }}</a>
                      </div>
                    </div>
              ...
              <div class="row justify-content-center">
                <div class="col-md-12">
                  <div class="card">
                    <div class="card-header">
                      <div class="d-flex justify-content-between">
                        <h4>Total Users {{ $contacts->count() }}</h4>
                      </div>
                    </div>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="parent-icon">
                                ...
                                <a href="{{ url('contact/upload/download') }}/{{ $contact->id }}"><i class="material-icons-outlined">download</i></a>
                                <a target="_blank" href="{{ asset('storage') }}/{{ $contact->contact_attachment }}"><i class="material-icons-outlined">description</i></a>
                              </div>
                              @endif
                              <!-- {{ $contact->contact_attachment }} -->
                            </td>
                          </tr>
                          @endforeach
                        </tbody>
            ...
            <div class="d-flex flex-column justify-content-between gap-4">
              <div class="d-flex align-items-center gap-4">
                <div class="d-flex align-items-center gap-3 flex-grow-1">
                  <img src="{{ asset('dashbord_assets') }}/assets/images/apps/17.png" width="32" alt="">
              ...
              <div class="d-flex align-items-center gap-4">
                <div class="d-flex align-items-center gap-3 flex-grow-1">
                  <img src="{{ asset('dashbord_assets') }}/assets/images/apps/18.png" width="32" alt="">
              ...
              <div class="d-flex align-items-center gap-4">
                <div class="d-flex align-items-center gap-3 flex-grow-1">
                  <img src="{{ asset('dashbord_assets') }}/assets/images/apps/19.png" width="32" alt="">
              ...
              <div class="d-flex align-items-center gap-4">
                <div class="d-flex align-items-center gap-3 flex-grow-1">
                  <img src="{{ asset('dashbord_assets') }}/assets/images/apps/20.png" width="32" alt="">
              ...
              <div class="d-flex align-items-center gap-4">
                <div class="d-flex align-items-center gap-3 flex-grow-1">
                  <img src="{{ asset('dashbord_assets') }}/assets/images/apps/05.png" width="32" alt="">
              ...
              <div class="d-flex align-items-center gap-4">
                <div class="d-flex align-items-center gap-3 flex-grow-1">
                  <img src="{{ asset('dashbord_assets') }}/assets/images/apps/08.png" width="32" alt="">
              ...
              <div class="d-flex align-items-center gap-4">
                <div class="d-flex align-items-center gap-3 flex-grow-1">
                  <img src="{{ asset('dashbord_assets') }}/assets/images/apps/07.png" width="32" alt="">
        ...
        <div class="card w-100 rounded-4">
          ...
          <div class="card-body p-0">
            <div class="user-list p-3">
              <div class="d-flex flex-column gap-3">
                <div class="d-flex align-items-center gap-3">
                  <img src="{{ asset('dashbord_assets') }}/assets/images/avatars/01.png" width="45" height="45" class="rounded-circle" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="{{ asset('dashbord_assets') }}/assets/images/avatars/02.png" width="45" height="45" class="rounded-circle" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="{{ asset('dashbord_assets') }}/assets/images/avatars/03.png" width="45" height="45" class="rounded-circle" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="{{ asset('dashbord_assets') }}/assets/images/avatars/04.png" width="45" height="45" class="rounded-circle" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="{{ asset('dashbord_assets') }}/assets/images/avatars/05.png" width="45" height="45" class="rounded-circle" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="{{ asset('dashbord_assets') }}/assets/images/avatars/06.png" width="45" height="45" class="rounded-circle" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="{{ asset('dashbord_assets') }}/assets/images/avatars/08.png" width="45" height="45" class="rounded-circle" alt="">
                  <div class="flex-grow-1">
                ...
                <tbody>
                  <tr>
                    <td>
                      <div class="d-flex align-items-center gap-3">
                        <div class="">
                          <img src="{{ asset('dashbord_assets') }}/assets/images/top-products/01.png" class="rounded-circle" width="50" height="50" alt="">
                        </div>
                  ...
                  <tr>
                    <td>
                      <div class="d-flex align-items-center gap-3">
                        <div class="">
                          <img src="{{ asset('dashbord_assets') }}/assets/images/top-products/02.png" class="rounded-circle" width="50" height="50" alt="">
                        </div>
                  ...
                  <tr>
                    <td>
                      <div class="d-flex align-items-center gap-3">
                        <div class="">
                          <img src="{{ asset('dashbord_assets') }}/assets/images/top-products/03.png" class="rounded-circle" width="50" height="50" alt="">
                        </div>
                  ...
                  <tr>
                    <td>
                      <div class="d-flex align-items-center gap-3">
                        <div class="">
                          <img src="{{ asset('dashbord_assets') }}/assets/images/top-products/04.png" class="rounded-circle" width="50" height="50" alt="">
                        </div>
                  ...
                  <tr>
                    <td>
                      <div class="d-flex align-items-center gap-3">
                        <div class="">
                          <img src="{{ asset('dashbord_assets') }}/assets/images/top-products/06.png" class="rounded-circle" width="50" height="50" alt="">
                        </div>
